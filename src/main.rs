...
use tixml2svd::{process_device, process_peripheral, Args};
    ...
    match bom {
        ...
        _ => {
            return Err(Error::new(
                ...
                format!("unsupported Unicode file encoding: {}", bom),
            ))
        }
    };
